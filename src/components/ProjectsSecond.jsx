...
import { AuraBliss, chocotonic, flickbite, freestyle } from "../assets";
        ...
        <div className=" flex flex-col md:flex-row gap-[15px] mb-project">
          ...
          >
            <a
              ...
              href="https://www.behance.net/gallery/185101787/Freestyle-Ecommerce-Landing-Page"
              target="_blank"
          ...
          >
            <a
              ...
              href="https://www.behance.net/gallery/119947985/Chocotonic"
              target="_blank"
              rel="noopener noreferrer"
              className="absolute w-36 h-11 -translate-x-1/2 -translate-y-1/2 
                         rounded-full bg-[#3545D6] text-white font-medium text-[16px]
